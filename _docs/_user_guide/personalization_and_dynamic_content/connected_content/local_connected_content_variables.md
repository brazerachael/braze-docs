...
[Metaweather](https://syncwith.com/api/metaweather-api) is a free weather API that uses a "Where-on-Earth ID" to return weather in an area. Use this code for testing and learning purposes only.
